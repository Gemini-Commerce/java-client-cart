...
import GeminiCommerce.Cart.auth.Authentication;
import GeminiCommerce.Cart.auth.HttpBasicAuth;
import GeminiCommerce.Cart.auth.HttpBearerAuth;
import GeminiCommerce.Cart.auth.ApiKeyAuth;
import GeminiCommerce.Cart.auth.OAuth;
import GeminiCommerce.Cart.auth.RetryingOAuth;
import GeminiCommerce.Cart.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Cart.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Cart.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Cart.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Cart.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Cart.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Cart.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Cart.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Cart.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Cart.ApiException If fail to serialize the request body object into a string
     */
