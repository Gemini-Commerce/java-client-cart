...
public class CartCreateCartRequest {
   ...
   * @return the CartCreateCartRequest instance itself
   */
  public CartCreateCartRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, cartCreateCartRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, cartCreateCartRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, channel, market, locale, customerGrn, currency, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CartCreateCartRequest>() {
           ...
           public CartCreateCartRequest read(JsonReader in) throws IOException {
             ...
             CartCreateCartRequest instance = thisAdapter.fromJsonTree(jsonObj);
