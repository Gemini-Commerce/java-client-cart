...
public class CartMoney {
   ...
   * @return the CartMoney instance itself
   */
  public CartMoney putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.units, cartMoney.units) &&
        ...
        Objects.equals(this.additionalProperties, cartMoney.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CartMoney>() {
           ...
           public CartMoney read(JsonReader in) throws IOException {
             ...
             CartMoney instance = thisAdapter.fromJsonTree(jsonObj);
