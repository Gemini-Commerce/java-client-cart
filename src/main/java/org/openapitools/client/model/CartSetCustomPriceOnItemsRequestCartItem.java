...
public class CartSetCustomPriceOnItemsRequestCartItem {
   ...
   * @return the CartSetCustomPriceOnItemsRequestCartItem instance itself
   */
  public CartSetCustomPriceOnItemsRequestCartItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, cartSetCustomPriceOnItemsRequestCartItem.id) &&
        ...
        Objects.equals(this.additionalProperties, cartSetCustomPriceOnItemsRequestCartItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, freeOfCharge, unset, customPriceRow, customPriceUnit, discountPercentage, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CartSetCustomPriceOnItemsRequestCartItem>() {
           ...
           public CartSetCustomPriceOnItemsRequestCartItem read(JsonReader in) throws IOException {
             ...
             CartSetCustomPriceOnItemsRequestCartItem instance = thisAdapter.fromJsonTree(jsonObj);
