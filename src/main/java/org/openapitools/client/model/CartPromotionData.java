...
public class CartPromotionData {
   ...
   * @return the CartPromotionData instance itself
   */
  public CartPromotionData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.promotionGrn, cartPromotionData.promotionGrn) &&
        ...
        Objects.equals(this.additionalProperties, cartPromotionData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(promotionGrn, type, payload, cartItemIds, name, description, couponCode, discount, vatAmount, vatPercentage, vatInaccurate, vatCalculated, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CartPromotionData>() {
           ...
           public CartPromotionData read(JsonReader in) throws IOException {
             ...
             CartPromotionData instance = thisAdapter.fromJsonTree(jsonObj);
